...
<head>
  ...
  .bg {
    /* The image used */
    background-image: url("img/ermolaos_arg.png");
...
<body id="routerOutlet" class="app header-fixed sidebar-fixed">
      ...
      <a class="navbar-brand" href="nurse.php" style="">
      ...
      <li class="nav-item px-3">
      <a class="nav-link" href="#">Room Asignment</a>
      </li>
      <li class="nav-item px-3">
      <a class="nav-link" href="#">New Patient</a>
      </li>
      <li class="nav-item px-3">
      <a class="nav-link" href="nurse_dcs.php">Doctor List</a>
      </li>
