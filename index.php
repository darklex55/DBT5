              ...
              <div class="row">
                <div class="col-sm-6 col-lg-3">
                  <div class="card text-white bg-danger">
                    <div class="card-body pb-0">
                      ...
                      '<a href="./treat.php" class="text-value text-white"><i style="margin-right: 10px;" class="fa fa-stethoscope" ></i>Treat your patients</a>' :
                      '<a href="./add_patient.php" class="text-value text-white"><i style="margin-right: 10px;" class="fa fa-ambulance"></i>Admit a new patient</a>'
                      ?>
                      <div><br></div>
                    </div>
                  </div>
                ...
                <div class="col-sm-6 col-lg-3">
                  <div class="card text-white bg-warning">
                    <div class="card-body pb-0">
                      <?php echo ($access_level == 1) ?
                      '<a href="./equipment.php" class="text-value text-white"><i style="margin-right: 10px;" class="fa fa-x-ray"></i>Request equipment</a>' :
                      '<a href="./nurse_edit_rooms.php" class="text-value text-white"><i style="margin-right: 10px;" class="fa fa-hospital"></i>Assign responsibilities</a>'
                      ?>
                      <div><br></div>
                    </div>
                  </div>
                  ...
                  <div class="card text-white bg-info">
                    <div class="card-body pb-0">
                      <div class="text-value">
                        <a href="<?php echo ($access_level == 1) ? "./doctors_patients.php" : "./nurses_patients.php"; ?>" class="text-white"><i style="margin-right: 10px;" class="fa fa-procedures"></i>View your patients</a>
                      </div>
                      <div><br></div>
                    </div>
                  </div>
